...
val1 = client.get_node("ns=2;i=219")
val2 = client.get_node("ns=2;i=220")
val3 = client.get_node("ns=2;i=221")
val4 = client.get_node("ns=2;i=222")
val5 = client.get_node("ns=2;i=223")
val6 = client.get_node("ns=2;i=224")
