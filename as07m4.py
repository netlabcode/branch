...
val9 = client.get_node("ns=2;i=304")
val10 = client.get_node("ns=2;i=305")
		...
		with conn1:
			...
			while True:
				...
				#Update OPC value
					...
					stringd = str(dt)+"+"+str(value1)+"+"+str(value2)+"+"+str(value3)+"+"+str(value4)+"+"+str(value5)+"+"+str(value6)+"+"+str(value7)+"+"+str(value8)+"+"+str(value9)+"+"+str(value10)
			...
			while True:
				...
				try: 
					...
					if check == 296:
						...
						print('Value 302 set to:',value)
					elif check == 303:
						val8.set_value(value, ua.VariantType.Int16)
						print('Value 303 set to:',value)
					elif check == 304:
						val9.set_value(value, ua.VariantType.Int16)
						print('Value 304 set to:',value)
					elif check == 305:
