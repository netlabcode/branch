...
val1 = client.get_node("ns=2;i=238")
val2 = client.get_node("ns=2;i=239")
val3 = client.get_node("ns=2;i=240")
val4 = client.get_node("ns=2;i=241")
val5 = client.get_node("ns=2;i=242")
val6 = client.get_node("ns=2;i=243")
